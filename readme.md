This repo consists basic code for finding time and space complexity of code , sugggest improvements and generate some test cases for the problem at `https://leetcode.com/problems/*` end point.

Its using Gemini API to analyse the written code which is fetched from leetcode using basic
DOM manipulation and then using Gemini API to find the time and space complexity of the code along with suggestions to improve it and ofc some test cases to test the code.
